...
import 'package:foodonwheel/screens/user/tabs/home/details/widgets/review_tab.dart';
import 'package:get/get.dart';

class BodyDetails extends StatefulWidget {
  final int index;
  final ProductModel? screenArguments;
  const BodyDetails({Key? key, this.screenArguments, required this.index})
      : super(key: key);
      ...
      return SafeArea(
        ...
        children: <Widget>[
          CustomHeader(
            title: '',
            quantity:
                Get.find<ProductDetailsController>().cardProductModel.length,
            internalScreen: true,
          ),
          Container(
          ...
          Obx(() => GestureDetector(
                onTap: () {
                  Get.find<ProductDetailsController>()
                      ...
                      .isLike(!Get.find<ProductDetailsController>()
                          .listProduct[widget.index]
                          .isLike
                          .value);
                },
                child: Container(
                  ...
                  child: IconBadge(
                    icon: Icons.favorite,
                    iconColor: Get.find<ProductDetailsController>()
                            .listProduct[widget.index]
                            .isLike
                            .value
                        ? theme.primaryColor
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        !Get.find<ProductDetailsController>()
                                ...
                                widget.screenArguments!.quantity.toString() ==
                                    "0"
                            ? GestureDetector(
                                onTap: () {
                                    ...
                                    InkWell(
                                        onTap: () {
                                          if (Get.find<
                                              ...
                                              .cardProductModel
                                              .isNotEmpty) {
                                            if (widget.screenArguments!.quantity
                                                    .value >
                                                1) {
                                              widget.screenArguments!.quantity
                                                  .value--;
                                            } else {
                                              Get.find<
                                                      ProductDetailsController>()
                  ...
                  Expanded(
                    child: TabBarView(
                      ...
                      children: [
                        DetaileButtomTab(
                            productDetaile:
                                widget.screenArguments!.about.toString()),
                        const ReviewTab()
                      ],
                    ),
                  ),
